...
const CommentsContainer = () => {
    ...
    return (
        <div className={"max-sm:w-full fixed " + ( commentsWrapper ? "top-0 sm:right-0" : "top-[100%] sm:right-[-100%]" ) + " duration-700 max-sm:right-0 sm:top-0 w-[40%] min-w-[400px] h-full z-50 bg-white shadow-2xl p-8 px-8 overflow-y-auto overflow-x-hidden"}>

            <div className="relative">
                <h1 className="text-xl font-medium">ความเห็น</h1>
                <p className="text-lg mt-2 w-[70%] text-dark-grey line-clamp-1">{title}</p>

                <button 
                    onClick={() => setCommentsWrapper(preVal => !preVal)}
                    className="absolute top-0 right-0 flex justify-center items-center w-12 h-12">
...

            {
                ...
                }) : <NoDataMessage message="ยังไม่มีความเห็น" />
            }
