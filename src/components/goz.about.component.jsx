...
import Treasurer from "../imgs/GOZ_Treasurer.jpg"
...
const AboutGoz = () => {
  return (
    <div>
        ...
        <hr className="border-grey my-5"/>
        <p className="text-2xl mx-3 my-3">ช่องทางการติดต่อ</p>
        <p className="list-disc ml-7">ห้อง 148 ชั้น M1 อาคารมหาจักรีสิรินธร 254 ถนนพญาไท แขวงวังใหม่ เขตปทุมวัน กรุงเทพมหานคร 10330 <br></br> 022184897</p>
        <hr className="border-grey my-5"/>
        <p className="text-2xl mx-3 my-3">ดาวน์โหลด</p>
        <ul className="list-disc ml-7">
            <li className="list-outside py-1 text-justify">
                <Link to='https://drive.google.com/drive/folders/1ZuqNc6AuAYUA8aE6YG_jxcq8jF_K8cOs?usp=drive_link' target="_blank" className="hover:underline">รูปแบบจดหมายและเอกสาร ก.อศ.</Link>
            </li>
            <li className="list-outside py-1 text-justify">
                <Link to='/asset' className="hover:underline">ตราสัญลักษณ์องค์กร</Link>
            </li>            
            <li className="list-outside py-1 text-justify">
                <Link to='/asset' className="hover:underline">APIs</Link>
            </li>            
        </ul>               
        <hr className="border-grey my-5"/>
        <p className="text-2xl mx-3 my-3">ระเบียบการเบิกจ่าย ก.อศ.</p>
        <img src={Treasurer} className="w-3/4 object-cover" />
        {/* <ul className="list-disc ml-7">
            <li className="list-outside py-1 text-justify">
