...
const CommentField = ({ action, index = undefined, replyingTo = undefined, setReplying }) => {
    ...
    return (
        <>
            ...
            placeholder="เขียนอะไรบางอย่าง" className="input-box pl-5 placeholder:text-dark-grey resize-none h-[150px] overflow-auto"></textarea>
            <p className="my-2 mx-3 text-[#DE5C8E]"><strong className="text-xl underline">คำแนะนำ</strong><br /> กรุณาแสดงความเห็นอย่างสุภาพและไม่ละเมิดผู้อื่น</p>
            <button className="btn-dark mt-5 px-5 " onClick={handleComment}
            >{action}</button>
        </>
    )
}
