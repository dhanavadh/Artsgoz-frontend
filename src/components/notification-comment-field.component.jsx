...
const NotificationCommentField = ({ _id, blog_author, index = undefined, replyingTo = undefined, setReplying, notification_id, notificationData }) => {
    ...
    const handleComment = () => {
        ...
        if(!comment.length){
            return toast.error("ยังไม่ได้เขียนข้อความ")
        }
    ...
    return (
        <>
            ...
            placeholder="ตอบกลับอะไรบางอย่าง" className="input-box pl-5 placeholder:text-dark-grey resize-none h-[150px] overflow-auto"></textarea>
