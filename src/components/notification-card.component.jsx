        ...
        <div className={"p-6 border-b border-grey border-l-black " + ( !seen ? "border-l-2" : "" )}>
                ...
                <div className="w-full">
                    <h1 className="font-medium text-xl text-dark-grey">
                        ...
                        <span className="font-normal">
                            {
                                type == 'like' ? "ถูกใจบทความของคุณ" : 
                                type == 'comment' ? "แสดงความเห็นว่า" : "ตอบกลับว่า"
                            }
                        </span>
                    </h1>
            ...
            <div className="ml-14 pl-5 mt-3 text-dark-grey flex gap-8">
...

                {
                    ...
                    <>
                        {
                            !reply ? 
                            <button className="underline hover:text-black" onClick={handleReplyClick}>ตอบกลับ</button> : ""
                        }
                        <button className="underline hover:text-black" onClick={(e) => handleDelete(comment._id, "comment", e.target)}>ลบ</button>
                    </> : ""
                }
...

            {
                ...
                <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                    <div className="flex gap-3 mb-3">
                        ...
                        <div>
                            <h1 className="font-medium text-xl text-dark-grey">
                                ...
                                <span className="font-normal">ตอบกลับถึง</span>
                    ...
                    <button className="underline hover:text-black ml-14 mt-2" onClick={(e) => handleDelete(reply._id, "reply", e.target)}>ลบ</button>
