        ...
        <AnimationWrapper>
            {
                ...
                <BlogContext.Provider value={{ blog, setBlog, islikedByUser, setLikedByUser, commentsWrapper, setCommentsWrapper, totalParentCommentsLoaded, setTotalParentCommentsLoaded }}>
                    ...
                    <CommentsContainer />
                    <img src={banner} className="max-w-screen h-96" />
                    ...
                    <div className="max-w-[900px] center py-10 max-lg:px-[5vw]">
                        ...
                        <div className="mt-12">
                            ...
                            <div className="flex max-sm:flex-col justify-between my-8">
                                ...
                                <p className="text-dark-grey opacity-75 max-sm:mt-6 max-sm:ml-12 max-sm:pl-5">เผยแพร่เมื่อ {getDay(publishedAt)}</p>
                            </div>
                        </div>
...

                        {
                            similarBlogs != null && similarBlogs.length ?
                                <>
                                    <h1 className="text-2xl mt-14 mb-10 font-medium">บทความที่คล้ายกัน</h1>
