...
const ManageBlogs = () => {
    ...
    return (
        <>
            <h1 className="max-md:hidden">จัดการบทความ</h1>
            ...
            <div className="relative max-md:mt-5 md:mt-8 mb-10">
                <input 
                    type="search"
                    className="w-full bg-grey p-4 pl-12 pr-6 placeholder:text-dark-grey"
            ...
            <InPageNavigation routes={["บทความที่เผยแพร่แล้ว", "ร่างบทความ"]} defaultActiveIndex={ activeTab != 'draft' ? 0 : 1 }>
                ...
                { // published Blogs
                    ...
                    : <NoDataMessage message="ยังไม่มีบทความที่เผยแพร่" />
                ...
                { // draft Blogs
                    ...
                    : <NoDataMessage message="ยังไม่มีร่างบทความ" />
