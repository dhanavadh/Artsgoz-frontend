...
const EditProfile = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if(username.length < 3){
            return toast.error("ชื่อผู้ใช้ควรยาวอย่างน้อย 3 ตัวอักษร")
        }
        if(bio.length > bioLimit){
            return toast.error(`ไบโอไม่ควรเกินกว่า ${bioLimit} ตัวอักษร`)
        }
        ...
        <AnimationWrapper>
            {
                ...
                <form ref={editProfileForm}>
                    ...
                    <h1 className="max-md:hidden">แก้ไขโปรไฟล์</h1>
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="max-lg:center mb-5">
                            ...
                            <button className="btn-light mt-5 max-lg:center lg:w-full px-10" onClick={handleImageUpload}>อัปโหลด</button>
                        </div>
                        ...
                        <div className="w-full">
                            ...
                            <p className="text-dark-grey -mt-3">ชื่อผู้ใช้งาน ใช้สำหรับค้นหาผู้คนต่าง ๆ</p>
                            ...
                            <p className="mt-1 text-dark-grey">เหลืออีก { charactersLeft } ตัวอักษร</p>

                            <p className="my-6 text-dark-grey">เพิ่มช่องทางการติดต่อ</p>
                            ...
                            <button className="btn-dark w-auto px-10" type="submit" onClick={handleSubmit}>อัปเดต</button>
