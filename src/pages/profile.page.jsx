                    ...
                    profile_username.length ?
                        <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12">
                            <div className="flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-l border-grey md:sticky md:top-[100px] md:py-10">
                                ...
                                <p>{total_posts.toLocaleString()} บทความ - {total_reads.toLocaleString()} ยอดรับชม</p>

                                <div className="flex gap-4 mt-2">
                                    {
                                        profileId == username ?
                                        <Link to="/settings/edit-profile" className="btn-light">แก้ไขโปรไฟล์</Link>
                                        : " "
                                    }
                                </div>
                            ...
                            <InPageNavigation
                                    routes={[ "บทความที่เผยแพร่" , "เกี่ยวกับ"]}
                                ...
                                >
                                    <>
                                        {blogs == null ? (
                                            ...
                                            : <NoDataMessage message="ยังไม่ได้เผยแพร่บทความ" />
                                        )}
